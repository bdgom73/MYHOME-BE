...
public class BoardController2 {
    ...
    private final AWS_S3Upload awsS3Upload;

    public BoardController2(MemberService memberService, BoardRepository boardRepository, CategoryRepository categoryRepository, ImageRepository imageRepository, RecommendRepository recommendRepository, CommentRepository commentRepository, MemberDetailRepository memberDetailRepository, AWS_S3Upload awsS3Upload) {
    ...
    public Long writePost(
        ...
        if(s.equals(CategoryList.FREE.toString())){
            ...
            for (MultipartFile multipartFile : files) {
                ...
                image.setFilename(result_url.getFilename());
